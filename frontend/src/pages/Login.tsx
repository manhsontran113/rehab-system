...
export const Login = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen bg-gradient-to-br from-teal-50 to-teal-100 dark:from-gray-900 dark:to-black flex items-center justify-center p-4 transition-colors duration-300">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-md border border-gray-200 dark:border-gray-700 transition-colors duration-300">
        <div className="text-center mb-8">
          <div className={`bg-${roleColor}-100 dark:bg-${roleColor}-900/30 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-4`}>
            {isDoctor ? (
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-3 font-semibold">Tài khoản mẫu:</p>
        ...
        <div className="mt-6 text-center">
          <Link
            to="/login-choice"
            className="text-lg text-gray-600 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition"
          >
